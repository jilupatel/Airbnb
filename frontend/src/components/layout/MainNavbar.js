        ...
        <div className="container-fluid" style={{ backgroundColor: "#ebebeb" }}>
          ...
          >
            ...
            <div className="navbar-collapse">
              {/* Left-aligned Links */}
              <div className="navbar-nav" style={{ marginTop: "-35px", fontWeight: "bold", fontSize: "20px", marginLeft: "-40px" }}>
                <Link className="nav-link" to="/" style={{ color: "#FF385C !important" }}>
                  WanderLust
                </Link>
              </div>
              ...
              <div className="navbar-nav ms-auto">
                ...
                <button style={{marginTop: "-30px",
                    color: "black",
                    marginRight: "20px", backgroundColor: "transparent"}} onClick={() => navigate("/add/your/home")}>
                WanderLust Your Home
                </button>
                <div className="dropdown-container">
                  ...
                  {/* Dropdown Menu */}
                  {isOpen && (
                    <ul className={`dropdown-menu ${isOpen ? "show" : ""}`} style={{ padding: "5px 10px" }}>
