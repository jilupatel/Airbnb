...
import AddGallery from "./Admin/AddGallery.js";
import AddYourHome from "./pages/AddYourHome.js";
import HostExperience from "./pages/HostExperience.js";
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        />
        <Route path="/add/your/home" element={<AddYourHome />} />
        <Route path="/host/experience" element={<HostExperience />} />
        <Route path="/admin/upload/gallery/image" element={<AddGallery />} />
